    ...
    <section className="relative h-screen w-full flex items-center justify-center bg-gradient-to-br from-[#f8f9fa] via-[#e8ecf1] to-[#dee2e6] dark:from-[#0f172a] dark:via-[#1e293b] dark:to-[#334155] overflow-hidden">
      ...
      <div className="z-10 text-center max-w-2xl px-6">
        ...
        <div className="flex justify-center gap-4">
          <button className="px-6 py-3 bg-black text-white dark:bg-white dark:text-black rounded-lg text-sm font-semibold hover:scale-105 transition transform duration-200 shadow-md">
            Get Started
          </button>
          <button className="px-6 py-3 border border-gray-500 text-gray-700 dark:text-gray-200 rounded-lg text-sm font-medium hover:bg-gray-100 dark:hover:bg-gray-800 transition duration-200">
            Learn More
          </button>
        </div>
      </div>
